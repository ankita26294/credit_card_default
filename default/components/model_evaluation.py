...
from default.utils import load_object
from sklearn.metrics import f1_score
import pandas  as pd
import sys,os
from default.config import TARGET_COLUMN
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            # print(f"Prediction using trained model: {current_target_encoder.inverse_transform(y_pred)}")
